...
class Qwen2VLModule(VLMBaseModule):
    ...
    def get_custom_multimodal_keywords(self):
        return ["pixel_values", "image_grid_thw", "mm_token_type_ids"]
    ...
    def prepare_prompt(
        ...
        # Use tokenizer for chat template if processor doesn't have one (e.g. Qwen3.5-Base)
        tokenizer = getattr(processing_class, 'tokenizer', processing_class)
        prompts_text = [
            maybe_apply_chat_template(example, tokenizer)["prompt"]
